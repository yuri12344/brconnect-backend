    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_whats', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.whatsappproductinfo', verbose_name='Produto WhatsApp')),
            ],
            options={
